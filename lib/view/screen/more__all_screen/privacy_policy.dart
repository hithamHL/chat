          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  "This Privacy Policy governs the manner in which [Your App/Company Name] collects, uses, maintains, and discloses information collected from users (each, a \"User\") of the [Your App] mobile application (\"App\"). This privacy policy applies to the App and all products and services offered by [Your App/Company Name].".tr,
                  style: TextStyle(
                    fontSize: 16,
                  ),
                ),
                SizedBox(height: 16.0),
                Text(
                  "Personal Identification Information".tr,
                  style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                  ),
                ...
                SizedBox(height: 16.0),
                Text(
                  "Non-Personal Identification Information".tr,
                  style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                  ),
                ...
                SizedBox(height: 8.0),
                Text(
                  "We may collect non-personal identification information about Users whenever they interact with our App. Non-personal identification information may include the browser name, the type of computer, and technical information about Users' means of connection to our App, such as the operating system and the Internet service providers utilized and other similar information.".tr,
                  style: TextStyle(
                    fontSize: 16,
                  ),
                ),
                SizedBox(height: 16.0),
                Text(
                  "How We Use Collected Information".tr,
                  style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                  ),
